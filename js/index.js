...
S.ShapeBuilder = (function () {
  ...
  function fit() {
    ...
    if (innetWidth < innerHeight) {
      shapeCanvas.width = Math.floor(innerHeight / gap) * gap;
      shapeCanvas.height = Math.floor(innetWidth / gap) * gap;
    } else {
      shapeCanvas.width = Math.floor(innetWidth / gap) * gap;
      shapeCanvas.height = Math.floor(innerHeight / gap) * gap;
    }
